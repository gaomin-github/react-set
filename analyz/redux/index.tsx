...
import './index.less';
import {update_NodeType,update_ModuleKey} from './actions'

import 'src/analyz/redux/graph'
...
class ReduxAnalyz extends React.PureComponent<IProp&IDispatchProps,stateProps>{
    constructor(props){
        super(props);
        this.state={
