import {createSelector} from 'reselect';
  ...
  export const selectQuery=createSelector(appState,appState=>appState.route)

  export const selectCurrentUser=createSelector(appState,appState=>appState.currentUser);
  ...
  export const selectAppconfigFavoritesHidden=createSelector(appState,appState=>appState.leanModeConfig.favoritesHidden);

  export const selectAppconfigWikiHidden=createSelector(appState,appState=>appState.leanModeConfig.wikiHidden);
...
export const selectBackUrlTest=createSelector(selectBackUrl,selectBackUrl=>`${selectBackUrl}_1`);
...
export const selectRecentObjTokensInBackNav=createSelector(indexes,indexes=>indexes.selectRecentObjTokensInBackNav);

export const selectRecentWikiInBackNav=createSelector(appState,appState=>appState.recentWikiInSuiteBackNav);
